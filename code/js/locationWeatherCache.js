...
function LocationWeatherCache()
{
    ...
    this.locationAtIndex = function(index) {
        return locations[index]   //Will this also need to parse values, or do we assume they are in javascript
    };
    ...
    {
        var locStat = {
            latitude: "", //take this values from drew's code
            longitude: "", // as above
            nickname: "",
            forecasts: "" //will need to have this as a connected API
        }
        locations[arrayLength]=locStat;
